...
const ProductCard = ({ isInside, product, handleRemoveProduct, handleAddProduct, orderProducts, handleQuantityChange }: Props) => {
    ...
    return (
        <Card key={product.id} className='p-2 hover:shadow-lg transition-shadow grid grid-cols-5 gap-3 dark:bg-zinc-800 cursor-pointer h-36 w-full overflow-hidden'>
