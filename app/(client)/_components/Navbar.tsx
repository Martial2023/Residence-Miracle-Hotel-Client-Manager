...
const Navbar = () => {
  ...
  return (
    <nav className='fixed top-2 left-0 right-0 z-50 h-16 md:h-14 border w-full md:px-[6%] px-2 p-4 bg-white dark:bg-zinc-900 flex items-center justify-between md:shadow-md md:rounded-full'>
      <Link
