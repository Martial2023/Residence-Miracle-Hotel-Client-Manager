...
export default function NumberInput({ label, defaultValue, minValue, setValue }: Props) {
    return (
        <NumberField defaultValue={defaultValue} minValue={minValue} onChange={setValue}>
